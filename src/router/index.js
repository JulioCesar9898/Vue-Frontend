...
// Prospecto
const ListProspectos = () => import('@/views/prospectos/ListProspectos')
const DetallesP = () => import('@/views/prospectos/DetallesP')
const EditProspectos= () => import('@/views/prospectos/EditProspectos')
const RegProspectos = () => import ('@/views/prospectos/RegProspectos')
const Evaluacion = () => import ('@/views/prospectos/Evaluacion')
          ...
          //Rutas Prospecto
{
  ...
  children: [
    ...
    {
      path: '/edit/:id',
      meta: { label: 'Edit Prospectos' },
      name: 'editprospectos',
      component: EditProspectos,
      meta:{
        requiresAdmin: true
      }
    },
